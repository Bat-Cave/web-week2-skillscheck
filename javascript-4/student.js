...
let faveColors = ['purple', 'gray', 'white']
...
const me = {
  firstName: 'Rico',
  superHeroName: 'Yeet Master',
  homeTown: 'Safford',
  superPowers: ['Mega Yeet', 'Life Yoink', 'Taco Bell Thunder'],
...
let setColor = arr => {
  ...
  for(let i = 0; i < color.length; i++){
    color[i] === 'blue' ? color[i] = '#4D4DFF' : color[i] = color[i];
  }
  return background(color[0], color[1], color[2])
}
